...
const NotificationBell = () => {
  ...
  // ── Fetch — reads new { notifications, unreadCount } shape ───────────────
  ...
  return (
    <>
      ...
      <div style={{ position: 'relative', fontFamily: "'DM Sans', sans-serif" }} ref={dropdownRef}>
              ...
              >
                {notifications.length === 0 ? (
                  <div style={{
                    ...
                    <p style={{ fontWeight: 800, fontSize: 14, color: '#0f2c4a', marginBottom: 4 }}>
                      All caught up!
                    </p>
                  ...
                  notifications.map((note, i) => {
                    ...
                    return (
                      <motion.div
                        ...
                        onMouseEnter={e => {
                          if (!note.isRead) e.currentTarget.style.background = cfg.bg;
                        }}
                        onMouseLeave={e => {
                          e.currentTarget.style.background = note.isRead ? 'transparent' : `${cfg.bg}80`;
                        }}
                      >
                        {/* Unread left bar */}
                        {!note.isRead && (
