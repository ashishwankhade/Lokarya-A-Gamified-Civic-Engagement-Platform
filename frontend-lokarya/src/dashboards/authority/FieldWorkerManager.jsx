...
const Field = ({ label, value, onChange, placeholder, type = 'text' }) => (
  <div style={{ marginBottom: 12 }}>
    ...
    <input
      ...
      style={{
        width: '100%', padding: '9px 12px', borderRadius: 9, background: '#f8fafc',
...
const PhoneField = ({ value, onChange }) => (
  <div style={{ marginBottom: 12 }}>
    ...
    <div style={{
      display: 'flex', borderRadius: 9, border: '1px solid #e2e8f0',
      overflow: 'hidden', background: '#f8fafc',
    }}>
      <span style={{
        padding: '9px 10px', background: '#f1f5f9', color: '#64748b',
        fontSize: 13, borderRight: '1px solid #e2e8f0', userSelect: 'none',
      ...
      <input
        ...
        style={{
          flex: 1, padding: '9px 12px', background: '#f8fafc', border: 'none',
...
const FieldWorkerManager = () => {
  ...
  const isFormValid = form.name.trim() && form.phone.length === 10;
  ...
  return (
    <div style={{ fontFamily: "'DM Sans',sans-serif", maxWidth: 820 }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 18 }}>
        <div>
          <h2 style={{ color: '#0f172a', fontWeight: 900, fontSize: 15, margin: 0 }}>Field Workers</h2>
          <p style={{ color: '#94a3b8', fontSize: 12, marginTop: 2, marginBottom: 0 }}>
            {workers.length} staff registered
          </p>
        </div>
        <button
          ...
          >
            <div style={{
              ...
              <p style={{
                ...
                textTransform: 'uppercase', letterSpacing: '0.07em', marginBottom: 16, marginTop: 0,
              }}>
                New Field Worker
              </p>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0 16px' }}>
                ...
                <Field
                  label="Vibhag"
                  value={form.vibhag}
                  onChange={v => setForm(p => ({ ...p, vibhag: v }))}
              ...
              <button
                ...
                style={{
                  ...
                  background: submitting || !isFormValid ? '#f1f5f9' : '#2563eb',
                  color: submitting || !isFormValid ? '#94a3b8' : '#fff',
      ...
      {loading ? (
        ...
        <div style={{
          ...
          <Users size={32} style={{ color: '#e2e8f0', margin: '0 auto 10px', display: 'block' }} />
          <p style={{ color: '#94a3b8', fontSize: 14, fontWeight: 700, margin: 0 }}>No field workers yet</p>
              ...
              >
                ...
                <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', marginBottom: 14 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                    ...
                    <div>
                      <p style={{ color: '#0f172a', fontWeight: 700, fontSize: 14, lineHeight: 1.3, margin: 0 }}>
                        {w.name}
                      </p>
                      <p style={{ color: '#94a3b8', fontSize: 10, fontFamily: "'JetBrains Mono',monospace", margin: 0 }}>
                        {w.employeeId || '—'}
                      </p>
                    </div>
                  </div>
